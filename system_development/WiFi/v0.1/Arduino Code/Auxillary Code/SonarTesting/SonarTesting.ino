...
float initHght1 = 100; //Elevation of the ultrasonic sensor 1 at set up, used
//to calibrate the sensor readings (usually done in reference to sea level)
float initHght2 = 100; //Elevation of the ultrasonic sensor 1 at set up, used
//to calibrate the sensor readings (usually done in reference to sea level)
...
void loop() {
  ...
  //   snprintf(dayStampFileName, 20, "%02d%02d%02d.txt", now.year(), now.month(), now.day());  
  ...
  //   Serial.println(timeStamp);
    ...
    Serial.print("The distance 1 read is ");
    Serial.print(distance1);
    Serial.print(" Height 1 is: "); //uncomment to debug
    Serial.print(height1);
    Serial.print(" The distance 2 read is ");
  ...
  //     if (dataFile){
  //       dataFile.println("Ultrasonic 1 Height Reading (ft),Ultrasonic 2 Height Reading (ft),Battery Voltage (V),Internal Temperature (F),Datetime");
  //       dataFile.close();
  //     }
  //     else {
